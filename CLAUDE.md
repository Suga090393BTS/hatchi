...
- **À chaque modif de fichier listé dans `sw.js`** : incrémenter `const CACHE = 'hatchi-vNN'` (ligne 2 de `sw.js`) sinon les appareils gardent l'ancienne version en cache. Version actuelle : **v64**.
